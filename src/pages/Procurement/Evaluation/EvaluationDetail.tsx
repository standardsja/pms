...
const EvaluationDetail = () => {
                ...
                <div class="page">
                    ...
                    <div class="section">
                        ...
                        <div class="content">
                            ...
                            <div class="field">
                                <div class="field-label">Recommended Contract Amount (inclusive of GCT)</div>
                                <div class="field-value">$${Number(evaluation.sectionC.recommendedAmountInclusiveGCT).toLocaleString('en-US', {
    ...
    return (
        <div className="evaluation-print-root">
            ...
            {/* Evaluator Complete Assignment Button now shown inline with Section C */}
