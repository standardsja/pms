        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="panel flex items-center justify-between">
                    ...
                    <Link to="/procurement/manager/rfqs-awaiting" className="btn btn-primary btn-sm">
                        Open Page
                    </Link>
                </div>
                <div className="panel flex items-center justify-between">
                    ...
                    <Link to="/procurement/manager/evaluations-to-validate" className="btn btn-primary btn-sm">
                        Open Page
                    </Link>
                </div>
            </div>
                                        ...
                                        <tr key={r.id} className="border-t border-gray-100 dark:border-gray-700">
                                            ...
                                            <td className="py-3 pr-4">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <button className="btn btn-primary btn-sm flex items-center gap-1" onClick={() => handleApproveRFQ(r)}>
