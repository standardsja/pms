            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-white dark:bg-slate-800 shadow rounded p-6">
                    <h2 className="text-lg font-semibold mb-4 flex items-center justify-between">
                        ...
                        <span className="text-sm font-normal text-gray-500">{requests.length} total</span>
                    </h2>
                    ...
                    {requests.length === 0 ? (
                        <div className="text-center py-12 text-gray-500 dark:text-gray-400">
                            ...
                            <p className="font-medium">No unassigned requests</p>
                            <p className="text-sm mt-1">All requests have been assigned to officers</p>
                        </div>
                    ) : (
