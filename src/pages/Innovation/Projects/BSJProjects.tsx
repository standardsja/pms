...
const BSJProjects = () => {
    ...
    const exportCsv = () => {
        ...
        filteredProjects.forEach(p => rows.push([
            p.projectCode || 'N/A',
            p.title,
            p.category,
            p.submittedBy,
            ...
            <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 p-8 text-white shadow-xl">
                <div className="relative z-10">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h1 className="text-4xl font-black">BSJ Projects</h1>
                    </div>
                    <p className="text-blue-100 text-lg">
                        Innovation ideas that have been approved and promoted to official BSJ projects
                    </p>
                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {paginatedProjects.map((project) => (
                            <div key={project.id} className="panel hover:shadow-xl transition-shadow">
                                ...
                                {/* Category Badge */}
                                <div className="mb-3">
                                    <span className={`px-3 py-1 rounded-full text-xs font-bold ${getCategoryColor(project.category)}`}>
                                ...
                                <div className="space-y-2 mb-4 text-sm text-gray-500 dark:text-gray-400">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span>by <strong>{project.submittedBy}</strong></span>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                {/* Actions */}
                                <Link
                                    to={`/innovation/ideas/${project.id}`}
