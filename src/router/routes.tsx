...
const EvaluatorAssignmentDetail = lazy(() => import('../pages/Procurement/Evaluation/EvaluatorAssignmentDetail'));
...
const routes = [
    ...
    {
        path: '/procurement/evaluation/:id/section-c',
        element: <EvaluatorAssignmentDetail />,
    },
    {
